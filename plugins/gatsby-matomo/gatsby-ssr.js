...
function buildTrackingCode() {
  var html = "\n var _paq = window._paq || [];\n_paq.push(['trackPageView']);\n_paq.push(['enableLinkTracking']);\n(function() {_paq.push(['setTrackerUrl', '//stats.opontolaranja.pt/oesdluh.php']);\n_paq.push(['setSiteId', '1']);\nvar d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];\ng.type='text/javascript'; g.async=true; g.defer=true; g.src='//stats.opontolaranja.pt/zyojpjy.php'; s.parentNode.insertBefore(g,s);\n})();\n"
...
function buildTrackingCodeNoJs() {
    var html = '<img src="//stats.opontolaranja.pt/oesdluh.php?wbu=1&kjj=1" style="border:0;" alt="" />';
