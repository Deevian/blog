module.exports = {
    siteUrl: `https://deev.io`, // Site domain. Do not include a trailing slash!

    postsPerPage: 10000, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)
